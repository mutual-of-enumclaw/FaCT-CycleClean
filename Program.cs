...
public class CycleClean : ICycleClean
{
    ...
    public async void Run()
    {
        try
        {
            ...
            var results = _dataProvider.ExecuteSql(cmd);
            ...
            foreach ( var item in results )
            {
                ...
                var BCDeleteSvcRq = new XElement("BCDeleteSvcRq",
                    ...
                    new XElement("CPPBCONTRq",
                        new XElement("PayLoad",
                            ...
                            new XElement("BC_KEY_POLICY_NUMBER", results.Result.Rows[item].ItemArray[0]["BC_KEY_POLICY_NUMBER"] ?? ""),
                            ...
                            new XElement("BC_LATEST_POLICY_NUMBER", results.Result.Rows[item].ItemArray[0]["BC_KEY_POLICY_NUMBER"] ?? ""),
                            ...
                            new XElement("BC_LATEST_POLICY_MODULE", results.Result.Rows[item].ItemArray[0]["BC_LATEST_POLICY_MODULE"] ?? ""),
                            new XElement("BC_SPECIAL_USE_B_DESC"),
                            new XElement("BC_RENEW_PAYBY_DESC"),
                            new XElement("BC_KEY_SYMBOL", results.Result.Rows[item].ItemArray[0]["BC_KEY_SYMBOL"] ?? ""),
                            ...
                            new XElement("BC_POLICY_CANCELLATION_DATE", results.Result.Rows[item].ItemArray[0]["BC_POLICY_CANCELLATION_DATE"] ?? ""),
                            ...
                            new XElement("BC_LATEST_POLICY_SYMBOL", results.Result.Rows[item].ItemArray[0]["BC_LATEST_POLICY_SYMBOL"] ?? ""),
                            ...
                            new XElement("BC_ENTERED_DATE", results.Result.Rows[item].ItemArray[0]["BC_ENTERED_DATE"] ?? ""),
                            ...
                            new XElement("PROC_EFFECTIVE_DATE", results.Result.Rows[item].ItemArray[0]["PROC_EFFECTIVE_DATE"] ?? ""),
                            ...
                            new XElement("BC_RENEWAL_SYMBOL", results.Result.Rows[item].ItemArray[0]["BC_LATEST_POLICY_SYMBOL"] ?? ""),
                            new XElement("BC_POLICY_EFFECTIVE_DATE", results.Result.Rows[item].ItemArray[0]["BC_POLICY_EFFECTIVE_DATE"] ?? ""),
                            new XElement("BC_LINE_OF_BUSINESS", results.Result.Rows[item].ItemArray[0]["BC_LINE_OF_BUSINESS"] ?? ""),
                            new XElement("PROC_TRANSACTION_TYPE", "RB"),
                            new XElement("BC_KEY_TRANSACTION_STATUS"),
                            new XElement("BC_RENEWAL_POLICY_NUMBER", results.Result.Rows[item].ItemArray[0]["BC_KEY_POLICY_NUMBER"] ?? ""),
                ...
                // Add elements to the root XML
                pointXml.Add(signonRq);
                pointXml.Add(BCDeleteSvcRq);
            }
